...
botCommands.forEach((command: Command, index: number) => {
...
bot.on('message', async (msg: Message) => {
    ...
    if (command === undefined) throw new Error('command is undefined');
    ...
    try {
        ...
        if (findCommand === undefined) throw new Error('command is undefined');
